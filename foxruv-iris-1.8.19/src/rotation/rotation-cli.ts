...
export class RotationCLI {
  private leagueManager: ExpertLeagueManager;
   ...
   */
  async showLeagues(expertType?: string): Promise<void> {
   ...
   */
  async showDriftingExperts(): Promise<void> {
   ...
   */
  async showMonitoringStatus(rotationId: string): Promise<void> {
   ...
   */
  async showRankingHistory(expertId: string, projectId: string): Promise<void> {
 ...
 * CLI entry point
 */
export async function runRotationCLI(args: string[]): Promise<void> {
