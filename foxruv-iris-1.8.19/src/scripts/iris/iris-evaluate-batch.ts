 ...
 */
function readQueue(queuePath: string): QueueEvent[] {
 ...
 */
function groupByProject(events: QueueEvent[]): Map<string, QueueEvent[]> {
  const grouped = new Map<string, QueueEvent[]>()
 ...
 * Clear queue file
 */
function clearQueue(queuePath: string): void {
