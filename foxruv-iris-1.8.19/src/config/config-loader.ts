 ...
 */
export async function loadIrisConfig(configPath?: string): Promise<IrisConfig> {
    ...
    try {
        ...
        const config = yaml.load(content) as IrisConfig
...
function validateAndNormalize(config: IrisConfig): IrisConfig {
