 ...
 */
export async function getRecentEvents(projectId, limit = 20) {
 ...
 */
export async function getAnomalies(projectId, limit = 20) {
    const supabase = getSupabase();
    const anomalies = [];
 ...
 */
export async function getAnomalyStats(projectId) {
