...
export class WhatsAppNotifier {
     ...
     * Format drift alert
     */
    formatDriftAlert(project, payload) {
        return [
            `🚨 *IRIS Drift Alert*`,
            `Project: ${project}`,
     ...
     */
    formatPromotion(project, payload) {
        return [
            `✨ *IRIS Promotion*`,
            `Project: ${project}`,
            `Expert: ${payload.expertId}`,
     ...
     */
    formatRetraining(project, payload) {
        return [
            `🔄 *Retraining Complete*`,
            `Project: ${project}`,
            `Expert: ${payload.expertId}`,
     ...
     */
    formatPatternDiscovery(project, payload) {
        return [
            `🔍 *Pattern Discovery*`,
            `Target: ${project}`,
 ...
 */
export function createWhatsAppNotifier(config) {
