...
var DropdownMenuSubTrigger = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(DropdownMenuPrimitive.SubTrigger, __assign({ ref: ref, className: (0, utils_1.cn)("flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent", inset && "pl-8", className) }, props, { children: [children, (0, jsx_runtime_1.jsx)(react_icons_1.ChevronRightIcon, { className: "ml-auto h-4 w-4" })] })));
});
