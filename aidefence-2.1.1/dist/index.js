import { AIMDSGateway } from './gateway/server.js';
import { logger } from './monitoring/telemetry.js';
...
export async function main() {
    try {
        ...
        const gateway = new AIMDSGateway(gatewayConfig, agentdbConfig, leanAgenticConfig);
