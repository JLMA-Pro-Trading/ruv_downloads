...
var generateCommand = new Command("generate").alias("gen").description("Generate MCP wrapper from OpenAPI spec or MCP server config").argument("[source]", "OpenAPI spec file or MCP server URL").option("-o, --output <path>", "Output directory", "./src/generated").option("-n, --name <name>", "Wrapper name").option("-t, --type <type>", "Source type: openapi, mcp, or auto", "auto").option("--no-types", "Skip TypeScript type generation").option("--no-validation", "Skip input validation").option("--experimental", "Enable experimental features").action(async (source, options) => {
