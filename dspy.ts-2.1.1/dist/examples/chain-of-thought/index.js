...
exports.mathProblemExample = mathProblemExample;
exports.logicalReasoningExample = logicalReasoningExample;
...
async function mathProblemExample() {
    ...
    const solver = new chain_of_thought_1.ChainOfThought({
    ...
    const problems = [
        {
            problem: 'A store has 15 apples. They sell 8 apples in the morning and 3 apples in the afternoon. How many apples are left?',
            expected: 4,
        },
        {
            problem: 'Sarah has $50. She buys a book for $12 and a pen for $3. How much money does she have left?',
            expected: 35,
        },
        {
            problem: 'A bus has 24 passengers. At the first stop, 8 people get off and 5 people get on. How many passengers are now on the bus?',
            expected: 21,
        },
    ];
    // Solve each problem
...
async function logicalReasoningExample() {
    ...
    await lm.init();
    (0, core_1.configureLM)(lm);
    const reasoner = new chain_of_thought_1.ChainOfThought({
