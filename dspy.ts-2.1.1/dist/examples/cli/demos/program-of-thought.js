...
exports.default = run;
const program_of_thought_1 = require("../../../src/modules/program-of-thought");
...
async function run() {
    ...
    const potModule = new program_of_thought_1.ProgramOfThought({
        name: 'MathSolver',
        signature: {
            inputs: [
                {
    ...
    const problems = [
        ...
        {
            problem: 'A company has 250 employees. 60% work remotely. Of those, 30% are international. How many international remote employees?',
    ...
    const advancedProblem = {
        problem: 'Calculate the average of the numbers [15, 23, 8, 42, 16, 31] and round to 2 decimal places',
...
//# sourceMappingURL=program-of-thought.js.map