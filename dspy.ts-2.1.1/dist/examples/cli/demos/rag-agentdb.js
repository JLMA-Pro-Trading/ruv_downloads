...
exports.default = run;
const retrieve_1 = require("../../../src/modules/retrieve");
const chain_of_thought_1 = require("../../../src/modules/chain-of-thought");
const client_1 = require("../../../src/memory/agentdb/client");
...
async function run() {
    ...
    const agentDB = new client_1.AgentDBClient({
        vectorDimension: 384,
        indexType: 'hnsw',
        storage: {
            path: './data',
    ...
    const retriever = new retrieve_1.Retrieve({
        k: 3,
        threshold: 0.3,
        rerank: true,
    });
    ...
    const ragSystem = new chain_of_thought_1.ChainOfThought({
        name: 'RAGSystem',
        signature: {
            inputs: [
                {
...
//# sourceMappingURL=rag-agentdb.js.map