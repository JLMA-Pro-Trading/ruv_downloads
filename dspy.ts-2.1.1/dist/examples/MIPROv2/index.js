...
const mipro_v2_pipeline_1 = require("./mipro-v2-pipeline");
const dummy_1 = require("../../src/lm/dummy");
async function main() {
    // Initialize model and module
    const model = new dummy_1.DummyLM();
    await model.init();
    const module = new mipro_v2_pipeline_1.MIPROv2Module(model);
