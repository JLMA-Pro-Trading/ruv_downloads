...
exports.ProgramOfThought = void 0;
 ...
 * ```
 */
class ProgramOfThought extends module_1.Module {
    constructor(config) {
        super({
            name: config.name,
    ...
    async run(input) {
        ...
        while (retries < this.maxRetries) {
            try {
                ...
                return Object.assign(Object.assign({}, output), { code: parsed.code, steps });
            }
            catch (error) {
     ...
     */
    buildPoTPrompt(input, previousError) {
            ...
            try {
                ...
                try {
                    vm = new vm2_1.VM({
                        ...
                        sandbox: Object.assign(Object.assign({}, this.sandbox), { Math,
                            Date,
                            Array,
                            Object,
                            String,
...
exports.ProgramOfThought = ProgramOfThought;
