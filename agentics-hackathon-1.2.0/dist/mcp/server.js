            ...
            switch (name) {
                ...
                case 'get_tracks':
                    return {
                        content: [{
                                type: 'text',
                                text: JSON.stringify(constants_js_1.TRACKS, null, 2)
                            }]
                    };
                case 'get_available_tools':
                    const category = args?.category;
                    const tools = category
                        ? constants_js_1.AVAILABLE_TOOLS.filter(t => t.category === category)
                        : constants_js_1.AVAILABLE_TOOLS;
                    return {
                        content: [{
                                type: 'text',
                ...
                case 'hackathon://config':
                    return {
                        contents: [{
                                uri,
                                mimeType: 'application/json',
                                text: JSON.stringify((0, index_js_1.loadConfig)() || { initialized: false }, null, 2)
                            }]
                    };
                ...
                case 'hackathon_starter':
                    return {
                        ...
                        messages: [{
                                ...
                                content: {
                                    type: 'text',
                                    text: `I'm participating in the ${constants_js_1.HACKATHON_NAME}. Help me get started by:\n` +
                        ...
                        messages: [{
                                ...
                                content: {
                                    ...
                                    text: `Help me choose a hackathon track. The available tracks are:\n` +
                                        Object.entries(constants_js_1.TRACKS)
