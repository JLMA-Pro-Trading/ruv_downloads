...
export type HackathonTrack = 'entertainment-discovery' | 'multi-agent-systems' | 'agentic-workflows' | 'open-innovation';
...
export type ToolCategory = 'ai-assistants' | 'orchestration' | 'databases' | 'cloud-platform' | 'synthesis' | 'python-frameworks';
