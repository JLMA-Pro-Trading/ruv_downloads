...
exports.PROJECT_README_TEMPLATE = exports.GITIGNORE_TEMPLATE = exports.INDEX_TS_TEMPLATE = exports.TSCONFIG_TEMPLATE = exports.PACKAGE_JSON_TEMPLATE = void 0;
const PACKAGE_JSON_TEMPLATE = (projectName, teamName) => ({
    name: projectName,
    version: '0.1.0',
...
exports.PACKAGE_JSON_TEMPLATE = PACKAGE_JSON_TEMPLATE;
...
temp/
`;
const PROJECT_README_TEMPLATE = (projectName, teamName, track) => `# ${projectName}
...
MIT
`;
exports.PROJECT_README_TEMPLATE = PROJECT_README_TEMPLATE;
